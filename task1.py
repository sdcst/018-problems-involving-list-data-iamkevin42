...
# Rounding to two decimal places without using the round() function
total = int(total * 100 + 0.005) / 100.0

print("Final amount at the end of the year:", total)
